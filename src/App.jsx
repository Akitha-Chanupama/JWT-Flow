        ...
        >
          <div className="mock-form">
            ...
            <div className="mock-form__field">
              <label className="mock-form__label">Email</label>
              <input
                className="mock-form__input"
                type="email"
            ...
            <div className="mock-form__field">
              <label className="mock-form__label">Password</label>
              <input
                className="mock-form__input"
                type="password"
                placeholder="••••••••"
            ...
            <button className="mock-form__btn" type="button">Login</button>
          </div>
...
// ✅ Credentials are valid — generate token`}
  ...
  "tokenType": "Bearer"
        ...
        <StepSection
          ...
          description="The client stores the token so it can be used for future requests. Common storage options include localStorage, sessionStorage, or HTTP-only cookies."
        >
...
const token = localStorage.getItem("token");`}
          ...
          <div className="info-card">
            <div className="info-card__icon" style={{ color: 'var(--warning)', background: 'rgba(251,191,36,0.12)' }}>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/>
                <line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/>
              </svg>
            </div>
            <h4 className="info-card__title">Security Note</h4>
            <p className="info-card__text">
              localStorage is vulnerable to XSS attacks. For better security, consider using HTTP-only cookies — they can't be accessed by JavaScript.
            </p>
          </div>
  ...
  headers: {
    ...
    "Content-Type": "application/json"
          ...
          <div className="lock-visual">
            <div className="lock-visual__icon">
              <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <rect x="3" y="11" width="18" height="11" rx="2" ry="2"/>
                <path d="M7 11V7a5 5 0 0 1 9.9-1"/>
              </svg>
            </div>
            <p className="lock-visual__text">
              The server validates the token's signature and checks if it's expired.<br />
              If valid → <strong style={{ color: 'var(--success)' }}>access granted</strong>. If invalid → <strong style={{ color: 'var(--error)' }}>401 Unauthorized</strong>.
            </p>
          </div>
        ...
        >
          ...
          <div className="expiry-visual">
            <div className="expiry-visual__card">
